...
export type SitePageContextGroupNodeAuthor = {
  node?: Maybe<SitePageContextGroupNodeAuthorNode>
}

export type SitePageContextGroupNodeAuthorNode = {
  name?: Maybe<Scalars["String"]>
}

export type SitePageContextGroupNodeCategories = {
  nodes?: Maybe<Array<Maybe<SitePageContextGroupNodeCategoriesNodes>>>
}

export type SitePageContextGroupNodeCategoriesNodes = {
  name?: Maybe<Scalars["String"]>
  id?: Maybe<Scalars["String"]>
  slug?: Maybe<Scalars["String"]>
}
...
export type SitePageContextNodeAuthor = {
  node?: Maybe<SitePageContextNodeAuthorNode>
}

export type SitePageContextNodeAuthorNode = {
  name?: Maybe<Scalars["String"]>
}

export type SitePageContextNodeCategories = {
  nodes?: Maybe<Array<Maybe<SitePageContextNodeCategoriesNodes>>>
}
...
/** Types of cards */
export type WpSeoCardType = "summary" | "summary_large_image"
...
export type SiteBuildMetanodedata = Node & {
  id: Scalars["ID"]
  parent?: Maybe<Node>
  children: Array<Node>
  internal: Internal
...
export type SitePageContextGroupNodeAuthorFilterInput = {
  node?: Maybe<SitePageContextGroupNodeAuthorNodeFilterInput>
}

export type SitePageContextGroupNodeAuthorNodeFilterInput = {
  name?: Maybe<StringQueryOperatorInput>
}

export type SitePageContextGroupNodeCategoriesFilterInput = {
  nodes?: Maybe<SitePageContextGroupNodeCategoriesNodesFilterListInput>
}

export type SitePageContextGroupNodeCategoriesNodesFilterListInput = {
  elemMatch?: Maybe<SitePageContextGroupNodeCategoriesNodesFilterInput>
}

export type SitePageContextGroupNodeCategoriesNodesFilterInput = {
  name?: Maybe<StringQueryOperatorInput>
  id?: Maybe<StringQueryOperatorInput>
  slug?: Maybe<StringQueryOperatorInput>
}
...
export type SitePageContextNodeAuthorFilterInput = {
  node?: Maybe<SitePageContextNodeAuthorNodeFilterInput>
}

export type SitePageContextNodeAuthorNodeFilterInput = {
  name?: Maybe<StringQueryOperatorInput>
}

export type SitePageContextNodeCategoriesFilterInput = {
  nodes?: Maybe<SitePageContextNodeCategoriesNodesFilterListInput>
}

export type SitePageContextNodeCategoriesNodesFilterListInput = {
  elemMatch?: Maybe<SitePageContextNodeCategoriesNodesFilterInput>
}
...
export type SitePageFieldsEnum =
  ...
  | "context___group___node___status"
  | "context___group___node___slug"
  | "context___group___node___excerpt"
  | "context___group___node___title"
  | "context___group___node___content"
  | "context___group___node___date"
...
export type WpurlQuery = {
  wp?: Maybe<{ generalSettings?: Maybe<Pick<WpGeneralSettings, "url">> }>
}
...
export type Unnamed_2_Query = {
          ...
          Pick<AirtableData, "Name" | "Github_Link" | "Live_URL"> & {
            Image?: Maybe<
              Array<
                Maybe<{
                  thumbnails?: Maybe<{
                    full?: Maybe<Pick<AirtableDataImageThumbnailsFull, "url">>
                    large?: Maybe<Pick<AirtableDataImageThumbnailsLarge, "url">>
                  }>
                }>
              >
            >
            Skills?: Maybe<
              Array<Maybe<{ data?: Maybe<Pick<AirtableData, "Name">> }>>
            >
          }
        >
      }
  ...
  developerSkills: {
    edges: Array<{
      node: Pick<Airtable, "id"> & { data?: Maybe<Pick<AirtableData, "Name">> }
    }>
  }
  networkingSkills: {
    edges: Array<{
  ...
  workExperience: {
    edges: Array<{
      node: Pick<Airtable, "id"> & {
        data?: Maybe<
          Pick<AirtableData, "Title" | "Type" | "Year" | "Location" | "Detail">
        >
      }
    }>
  }
    ...
    edges: Array<{
      node: Pick<Airtable, "id"> & {
        data?: Maybe<
          Pick<
            AirtableData,
            "Title" | "Type" | "Year" | "Location" | "Received"
          >
        >
      }
    }>
...
export type Unnamed_3_Query = {
  menu: {
    edges: Array<{
      node: {
        menuItems?: Maybe<{
          nodes?: Maybe<Array<Maybe<Pick<WpMenuItem, "id" | "path" | "label">>>>
        }>
      }
    }>
  }
  user?: Maybe<Pick<WpUser, "firstName" | "lastName">>
}
...
export type Unnamed_4_Query = {
  ...
  aboutPage: {
    edges: Array<{
      node: Pick<WpPage, "slug" | "content"> & {
        featuredImage?: Maybe<{
          node?: Maybe<
            Pick<WpMediaItem, "altText"> & {
              localFile?: Maybe<{
                small?: Maybe<{
                  fluid?: Maybe<Pick<ImageSharpFluid, "srcWebp">>
                }>
                large?: Maybe<{
                  fluid?: Maybe<Pick<ImageSharpFluid, "srcWebp">>
                }>
